...
import { fetchLeaderBoardScores, setupRealTimeLeaderBoard } from './TicTacToeScoreService';
...
export default function Leaderboard() {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      <h2 className="text-2xl font-bold mb-4 text-center"> Tic Tac Toe Leaderboard</h2>
      <table className="w-full text-left border-collapse border border-gray-400">
        <thead className="bg-gray-100">
          <tr>
            <th className="p-2 border border-gray-300">Username</th>
            <th className="p-2 border border-gray-300">Wins</th>
            <th className="p-2 border border-gray-300">Draws</th>
        ...
        <tbody>
          {scores.map((player, i) => (
            <tr key={i} className="hover:bg-gray-50">
              ...
              <td className="p-2 border border-gray-300">{player.draws}</td>
